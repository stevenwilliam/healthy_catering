...
const (
	...
	KeyWAHAURL              = "whatsapp.waha_url"
	KeyWAHASession          = "whatsapp.waha_session"
	KeyWAHAAPIKey           = "whatsapp.waha_api_key"
	KeyMailHost             = "mail.host"
	KeyMailUsername         = "mail.username"
	KeyMailPassword         = "mail.password"
	KeyMailFromEmail        = "mail.from_email"
	KeyMailFromName         = "mail.from_name"
